...
public class StationaryProjectile extends Projectile {
     ...
     */
    public StationaryProjectile(AbstractGameScreen screen, Entity owner, int width, int height, Texture sheet, int damage, float frameTime, float lifeTime, boolean followMouse, BiConsumer<Projectile, Float> tick, BiConsumer<Projectile, Entity> hit, boolean friendly) {
    ...
    public void render(Batch batch, float deltaTime) {
        ...
        Vector2 camPos = new Vector2(screen.game.camera.position.x, screen.game.camera.position.y);
